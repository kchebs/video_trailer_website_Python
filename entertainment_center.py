import media
import website_creator

# Movies
vvendetta = media.Video("V for Vendetta", 2006, "movie",
...
payitforward = media.Video("Pay it Forward", 2000, "movie", "A young boy "
                                                            ...
                                                            "after his teacher"
                                                            " suggests it.",
                           "https://ia.media-imdb.com/images/M/MV5BNjI3ODI5NDEwMl5BMl5BanBnXkFtZTYwNDYyMjU3._V1_.jpg",
                           "https://www.youtube.com/watch?v=qfW0wCV9iFI", 7.2,
                           4, 7.7)
starwars = media.Video("Star Wars: Episode IV - A New Hope", 1977,
                       ...
                       "https://www.youtube.com/watch?v=1g3_CFmnU7k", 8.6,
                       9.3, 9.6)
aladdin = media.Video("Aladdin", 1992, "movie", "When a street urchin vies for "
                      ...
                      9.2)
soundofmusic = media.Video("Sound of Music", 1965, "movie", "A woman leaves an "
                                                            "Austrian convent to"
                                                            " become a governess"
                                                            " to the children of"
                                                            " a Naval officer "
...
dalmations = media.Video("101 Dalmations", 1961, "movie", "When a litter of "
                         ...
                         7.2, 9.8, 7.5)
marypoppins = media.Video("Mary Poppins", 1964, "movie",
                          "In turn of the century London, a magical nanny "
                          "employs music and adventure to help two neglected "
                          "children become closer to their father.",
                          "https://upload.wikimedia.org/wikipedia/en/7/78/Marypoppins.jpg",
                          "https://www.youtube.com/watch?v=nOfH7uEojKk", 7.8,
                          10, 8.6)
...
homealone = media.Video("Home Alone", 1990, "movie", "An eight-year-old "
                        ...
                        7.9)
hpotterdhtwo = media.Video("Harry Potter and the Deathly Hallows - Part 2",
                           2011, "movie",
                           "Harry, Ron, and Hermione search for "
                           "Voldemort's remaining Horcruxes in their "
                           "effort to destroy the Dark Lord as the final "
                           "battle rages on at Hogwarts.",
                           "https://ia.media-imdb.com/images/M/MV5BMjIyZGU4YzUtNDkzYi00ZDRhLTljYzctYTMxMDQ4M2E0Y2YxXkEyXkFqcGdeQXVyNTIzOTk5ODM@._V1_SX667_CR0,0,667,999_AL_.jpg",
                           "https://www.youtube.com/watch?v=mObK5XD8udk", 8.1,
                           9.6, 8.9)
lordringstwo = media.Video("Lord of the Rings: The Two Towers", 2002, "movie",
